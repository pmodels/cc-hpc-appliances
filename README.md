...
This project provides a reproducible MPI setup on the Chameleon testbed. It deploys a master–worker MPI cluster. The master node manages tasks and communication, 
while the worker nodes do the computations.
