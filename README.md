...
- **Quick Start Examples**: Jupyter notebooks using Python-CHI and [OpenStack Heat Template for Bare Metal Instances](https://chameleoncloud.org/appliances/132/), [Openstack Heat Template for KVM](https://chameleoncloud.org/appliances/133/) are included for rapid experimentation and deployment, helping you get started with minimal effort.
